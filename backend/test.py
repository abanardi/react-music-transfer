...
@app.route('/step_one')
def authorize():
    client_id = requests.args.get('client_id')
    client_secret = requests.args.get('client_secret')
    redirect_uri = requests.args.get('redirect_uri')
...
@app.route('/step_two')
def authorize_two(client_id, client_secret, redirect_uri, callback_url):
...
# @app.route('/complete_auth')
# def authorize_complete(client_id, client_secret, redirect_uri):
